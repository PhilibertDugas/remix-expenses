...
function Chart({ expenses }: Props) {
  ...
  return (
    <section>
      <h2 className="text-white font-bold mb-2">Monthly Expenses</h2>
      <ol className="grid grid-cols-12 justify-items-center gap-3 p-6 rounded-md border-2">
